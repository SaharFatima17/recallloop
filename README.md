...
> Add at least 3 screenshots here after you run the app (locally or on
> the live deployment) — see the checklist at the bottom of this
> README for exactly what to capture.

![Dashboard](docs/screenshot-dashboard.png)
![AI flashcard generation](docs/screenshot-generate.png)
![Study mode](docs/screenshot-study.png)
